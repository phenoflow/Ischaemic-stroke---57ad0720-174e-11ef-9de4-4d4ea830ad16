...
(async () => {
  ...
  await fs.writeFile("ischaemic-stroke-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ischaemic-stroke-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
